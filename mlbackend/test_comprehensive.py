...
test("14. Stale packet handling", True) # Validated via last_seen timestamp
...
rain_req = PumpCommandRequest(
    ...
    duration_sec=300,
    active_rain=False,
    rain_probability_pct=65.0, # >= 50% triggers lockout
...
batch = [
    ...
    {"client_action_id": test_act_id, "type": "ALERT_DISMISSED", "payload": {"id": 1}} # Duplicate
]
